...
# FormFlow AI - Google Cloud Shell Deployment Script (No Git)
...
# Step 1: Skip git clone - use uploaded files
echo "1️⃣ Using uploaded files..."
...
terraform plan \
  ...
  -var="region=$REGION" \
  -var="domain=$DOMAIN" \
  -var="admin_email=alimehmetoglu90@gmail.com"
...
echo "  -var=\"admin_email=alimehmetoglu90@gmail.com\""
echo ""
